...
\footnote{Čekání ve~smyčce na~odemknutí zámku se nazývá aktivní čekání a~nezanedbatelně plýtvá zdroji.}
...
\begin{itemize}
	...
	\item BSS (Block Started by Symbol) -- neinicializované globální a~statické proměnné, kde hodnota může být náhodná hodnota z~paměti nebo 0 (pro ukazatele \emph{null}).
...
. Takto lze jednoduše sdílet soubor mezi procesy. Pro~práci s~tímto souborem se používají paměťové funkce, což zvyšuje rychlost operací čtení a~zápisu. Nevýhodou může potenciální plýtvání paměti%
