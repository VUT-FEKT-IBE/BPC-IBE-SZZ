...
\title{BPC-IC2}                     % Název dokumentu - Povinný
\newcommand{\subtitle}{Otázky a odpovědi BPC-IC2 (Bezpečnost ICT 2)}     % Popis dokumentu - Nepovinný
\author{kamen-u-cesty}                % Autor           - Nepovinný
...
\usepackage{wrapfig}            % zarovnání obrázků do bloku
