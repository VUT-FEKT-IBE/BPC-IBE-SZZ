...
\title{BPC-MDS}                     % Název dokumentu - Povinný
\newcommand{\subtitle}{Otázky a odpovědi BPC-MDS (Multimediální služby)}     % Popis dokumentu - Nepovinný
\author{vikča}                           % Autor           - Nepovinný
