...
\title{BPC-UP2A}
\newcommand{\subtitle}{Otázky a odpovědi BPC-UP2A (Úvod do práva ICT2)}
\author{kámen u~cesty, jedla}
\newcommand{\grammar}{Czechbol}
\newcommand{\formatting}{kámen-u-cesty, Czechbol}
...
\usepackage{sectsty}
% Zmenšení prostoru kolem nadpisů
\usepackage{titlesec}
...
% Pro možnost zalomení části textu pokud není na současné stránce dost místa
