...
\title{BPC-ZSY}                     % Název dokumentu - Povinný
\newcommand{\subtitle}{Otázky a odpovědi BPC-ZSY (Zabezpečovací systémy)}     % Popis dokumentu - Nepovinný
\author{dikubi}                           % Autor           - Nepovinný
