...
\includepdf[pages={1,2,3,4}]{pdfSources/BZSYstatnice.pdf}
...
\includepdf[pages={5,6,7,8}]{pdfSources/BZSYstatnice.pdf}
...
\includepdf[pages={9,10,11,12}]{pdfSources/BZSYstatnice.pdf}
...
\includepdf[pages={13,14,15}]{pdfSources/BZSYstatnice.pdf}
...
\includepdf[pages={16,17,18,19}]{pdfSources/BZSYstatnice.pdf}
...
\includepdf[pages={20,21,22}]{pdfSources/BZSYstatnice.pdf}
...
\includepdf[pages={23,24,25}]{pdfSources/BZSYstatnice.pdf}
...
\includepdf[pages={26,27}]{pdfSources/BZSYstatnice.pdf}
...
\includepdf[pages={28,29}]{pdfSources/BZSYstatnice.pdf}
...
\includepdf[pages={30,31}]{pdfSources/BZSYstatnice.pdf}